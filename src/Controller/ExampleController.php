...
class ExampleController extends AbstractController
{
    ...
    /**
     * @Route("/example/metaData", name="example/metaData")
     */
    public function metaData(CernerFhir $fhirApi)
    {
        ...
        return new Response("<pre>".print_r($p, true));
    }

    /**
     * @Route("/example/getPatient", name="example/getPatient")
     */
    public function getPatient(CernerFhir $fhirApi)
    {
        $id = '1316024';
    ...
    /**
     * @Route("/example/getPerson", name="example/getPerson")
     */
    public function getPerson(CernerFhir $fhirApi)
    {
        // Person 4342009
        $id = '4342009';
    ...
    /**
     * @Route("/example/getPractitioner", name="example/getPractitioner")
     */
    public function getPractitioner(CernerFhir $fhirApi)
    {
    ...
    /**
     * @Route("/example/getAppointment", name="example/getAppointment")
     * 
     * See https://fhir.cerner.com/millennium/dstu2/scheduling/appointment/
     */
    public function getAppointment(CernerFhir $fhirApi)
    {
    ...
    /**
     * @Route("/example/getSchedule", name="example/getSchedule")
     */
    public function getSchedule(CernerFhir $fhirApi)
    {
    ...
    /**
     * @Route("/example/getSlotSearch", name="example/getSlotSearch")
     */
    public function getSlotSearch(CernerFhir $fhirApi)
    {
    ...
    /**
     * @Route("/example/getSlot", name="example/getSlot")
     */
    public function getSlot(CernerFhir $fhirApi)
    {
